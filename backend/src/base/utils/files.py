...
from base.utils.exceptions import S3ConnectionError, S3UploadError, S3DownloadError, S3OtherError, S3DeleteError
...
class S3Wrapper:
    ...
    def upload_file(self, file_name: str, file: bytes | BytesIO | InMemoryUploadedFile) -> bool:
        """
        Upload file to S3
